...
/***/ 149:
/*!**************************************************************************!*\
  !*** /Users/mac/Desktop/百锐通/百锐通维修/main.js?{"page":"pages%2Fme%2Findex"} ***!
  \**************************************************************************/
...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./pages/me/index.vue */ 150));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/***/ 150:
/*!*******************************************************!*\
  !*** /Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue ***!
  \*******************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_373b9194___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=373b9194& */ 151);
...
/***/ 151:
/*!**************************************************************************************!*\
  !*** /Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=template&id=373b9194& ***!
  \**************************************************************************************/
...
/***/ 152:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=template&id=373b9194& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 153:
/*!********************************************************************************!*\
  !*** /Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 154:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _cloudApi = _interopRequireDefault(__webpack_require__(/*! ../../common/cloudApi.js */ 146));
var _index = __webpack_require__(/*! @/models/index.js */ 155);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
{
                ...
                success: function success(res) {
                  ...
                  _cloudApi.default.call({
                    ...
                    success: function success(res) {
                      ...
                      getApp().globalData.userInfo = _this.userInfo;
                      getApp().globalData.openid = _this.userInfo.openid;
                      _this.getOrderInfo();
                    } });
  ...
  methods: {
    /** 更新用户数据 */
    updataUserProfile: function updataUserProfile() {var _this2 = this;
      uni.getUserProfile({
        desc: "提示信息",
        success: function success(res) {
          _this2.userInfo = Object.assign(_this2.userInfo, res.userInfo);
          getApp().globalData.openid = _this2.userInfo.openid;
    ...
    goOrder: function goOrder(num) {
      uni.navigateTo({
        url: "/pages/orders/orders?index=".concat(num) });

    },
    goAddPic: function goAddPic() {
      uni.navigateTo({
    ...
    getOrderInfo: function getOrderInfo() {var _this3 = this;
      if (this.userInfo.openid) {
        (0, _index.getOrderList)(this.userInfo.openid).then(function (res) {
          if (res.status == 200) {
            if (res.data.length) {var _JSON$parse =
              JSON.parse(JSON.stringify(res)),data = _JSON$parse.data;
              var notPayList = data.filter(function (item) {
                return !item.orderIdInfo.isPay;
              });
              var repairList = data.filter(function (item) {
                return item.orderIdInfo.repairStatus === 0 || item.orderIdInfo.repairStatus === 1;
              });
              _this3.repairList = repairList;
              var time = new Date().getTime();
              notPayList.forEach(function (item) {
                if (Number(item.orderIdInfo.createTime) + 86400000 > time) {
                  // 未超过24小时不予处理
                  _this3.notPayList.push(item);
                } else {
                  // 超过24小时超时处理 删除超时订单
                  (0, _index.deleteOverTimeOrder)(item.orderIdInfo._id).then(function (resp) {
...
/***/ 158:
/*!****************************************************************************************!*\
  !*** /Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 159:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/mac/Desktop/百锐通/百锐通维修/pages/me/index.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
